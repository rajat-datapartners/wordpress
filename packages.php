...
<!-- Mirrored from zrtechsolutions.com/demo/html/technoit/packages.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Feb 2024 09:42:59 GMT -->
<head>
  <meta charset="utf-8">
                ...
                <div class="card text-center">
                  ...
                  <div class="option">
                    <ul>
                      ...
                      <li class="not-selected"><i class="bi bi-x-circle" aria-hidden="true"></i> Free Templates</li>
                      <li class="not-selected"><i class="bi bi-x-circle" aria-hidden="true"></i> Free Email</li>
                      <li class="not-selected"><i class="bi bi-x-circle" aria-hidden="true"></i> 10 Databases</li>
                      <li class="not-selected"><i class="bi bi-x-circle" aria-hidden="true"></i> Unlimited Email Address</li>
                      <li class="not-selected"><i class="bi bi-x-circle" aria-hidden="true"></i> Live Support</li>
                    </ul>
                  </div>
                  <a href="#">Order Now</a>
                </div>
