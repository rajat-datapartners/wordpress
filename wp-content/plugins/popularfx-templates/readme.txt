...
= 1.2.6 (Sep 06, 2024) =
* [Bug-Fix] In some cases, the Install PageLayer Pro functionality on the license page was not working properly. This is fixed.

= 1.2.5 (Jul 26, 2024) =
* [Task] PageLayer free is required to use PopularFX, if you are using PageLayer pro 1.8.6 or above.
