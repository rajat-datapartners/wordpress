...
if ( ! class_exists( 'ReduxFramework' ) ) {
	...
	// Redux API class  :)
	require_once __DIR__ . '/inc/class.redux_api.php';

	// General helper functions
	require_once __DIR__ . '/inc/class.redux_helpers.php';

	// General functions
	require_once __DIR__ . '/inc/class.redux_functions.php';
	require_once __DIR__ . '/inc/class.p.php';

	require_once __DIR__ . '/inc/class.thirdparty.fixes.php';

	require_once __DIR__ . '/inc/class.redux_filesystem.php';

	require_once __DIR__ . '/inc/class.redux_admin_notices.php';

	// ThemeCheck checks
	require_once __DIR__ . '/inc/themecheck/class.redux_themecheck.php';
	...
	class ReduxFramework {
		...
		private function _internationalization() {
			...
			if ( ! $loaded ) {
				...
				$mofile = __DIR__ . '/languages/redux-framework-' . $locale . '.mo';
		...
		private function compareValueDependencies( $parentValue, $checkValue, $operation ) {
			...
			switch ( $operation ) {
				...
				case 'contains':
					...
					} elseif ( strpos( $parentValue, (string) $checkValue ) !== false ) {
							$return = true;
					}
