...
function aasta_customizer_theme_settings( $wp_customize ){
    ...
    $wp_customize->get_section( 'header_image' )->priority = 40;
		...
		$wp_customize->add_setting(
			...
			array(
				'sanitize_callback' =>  'aasta_sanitize_text',
				'default' => __('Copyright &copy; 2024 | Powered by <a href="//wordpress.org/">WordPress</a> <span class="sep"> | </span> Aasta theme by <a target="_blank" href="//themearile.com/">ThemeArile</a>', 'aasta'),
